<div class="items-center w-full flex flex-col sm:flex-row relative p-2 gap-3">
    <div class="aspect-16/9 w-full sm:w-56 flex-none z-[1] bg-skeleton rounded-lg animate-pulse"></div>
